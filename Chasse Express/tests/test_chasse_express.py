...
from ui import obtenir_surface_panneau, dessiner_icone_texte, dessiner_texte_avec_contour, dessiner_panneau_etat, dessiner_fond
...
class TestUtilityFunctions(unittest.TestCase):
    def test_get_best_font(self):
        ...
        font = chasse_express.get_best_font("Consolas", 20)
        self.assertIsNotNone(font)

    def test_get_panel_font(self):
        # Vérifie que get_panel_font retourne une police
        font = chasse_express.get_panel_font("Consolas", 20)
        self.assertIsNotNone(font)
    ...
    def test_draw_status_panel(self):
        ...
        font = chasse_express.get_best_font("Consolas", 20)
        stat_font = chasse_express.get_panel_font("Consolas", 20)
